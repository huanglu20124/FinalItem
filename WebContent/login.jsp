...
<head>
    ...
    <style type="text/css">
		...
		#forgetPassw{ float: right; font-size: 0.8em; margin: 0 auto 20px;}
		#loadButton input{
			clear: both;
			display: block;
			margin: 30px auto;
		...
		<div id="form">
			<form action="login.jsp" method="post">
				<div class="formItem" id="username">
					...
					type="text" maxlength=60 placeholder="请输入账号"></div>
				<div class="formItem" id="password">
					<input name="user_password"  value="<%=user_password %>"
					type="password" maxlength=60 placeholder="请输入密码"></div>
				<div class="formItem" id="autoLoad"><input name="autoLogin" type="checkbox"><span style="font-size:0.8em; vertical-align:top;">下次自动登录</span></div>
				<div id="forgetPassw"><a href="#">忘记密码？</a></div>
				<div class="formItem" id="loadButton"><input name="load" type="submit" value="登录"></div>
