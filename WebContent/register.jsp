...
<body>
	...
	<div id="header">
		<div id="subheader">
			...
			<div id="choice">
				<a href="register.jsp" id='registerChoice'>注册</a> <a
					href="login.jsp" id='loadChoice'>登陆</a>
			</div>
		</div>
	</div>
	<div id="contents">
		<div id="form">
			<form action="register.jsp" method="post">
				<div class="formItem">
					...
					<input name="user_account" value="<%=user_account%>"
					type="text" maxlength=60 placeholder="请输入登录账号" class='input'>
				</div>
				<div class="formItem">
					<label for="password"><span class="inputName">登陆密码：</span></label>
					<input name="user_password" value="<%=user_password %>" 
					type="password" maxlength=60 placeholder="请输入登录密码" class='input'>
				</div>
				<div class="formItem">
					<label for="title"><span class="inputName">手机号码：</span></label> <input
						name="telephone" value="<%=telephone %>" 
						type="text" maxlength=60 placeholder="请输入手机号码" class='input'>
				</div>
				<div class="formItem">
					<label for="title"><span class="inputName">邮箱地址：</span></label> <input
						name="email" value="<%=email%>" 
						type="text" maxlength=60 placeholder="请输入邮箱地址" class='input'>
				</div>
				<div class="formItem">
					<label for="question"><span class="inputName">密保问题：</span></label>
					<select name="user_problem" style="width: 256px; height: 38px"
						class='input'>
				...
				<div class="formItem">
					<label for="title"><span class="inputName">输入答案：</span></label> <input
						name="user_answer" value="<%=answer%>"
						type="text" maxlength=60 placeholder="请输入密保答案" class='input'>
				</div>
				<div class="formItem">
					<input name="permission" type="checkbox" value="h1"><span
						id="permission">我已经阅读并同意<a
